...
def nerf_c2w_to_extrinsic_torch(c2w):
    return torch.linalg.inv(swap_mat_torch(c2w))

def nerf_extrinsic_to_c2w_torch(ext):
    return swap_mat_torch(torch.linalg.inv(ext))
